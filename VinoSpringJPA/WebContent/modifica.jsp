...
%>
	<div class="container">
		...
		<form class="form-horizontal" action="ExecuteModificaVinoServlet"
			method="post">
			<div class="form-group">
				<label class="control-label col-sm-2" for="nomeInputId">Nome:</label>
				<div class="col-sm-4">
					<input class="form-control" type="text" id="nomeInputId"
						name="nomeInput" value="<%= vinoInPagina.getNome()%>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="uvaInputId"
						name="uvaInput" value="<%= vinoInPagina.getUva()%>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="annataInputId"
						name="annataInput" value="<%= vinoInPagina.getAnnata()%>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="cantinaInputId"
						name="cantinaInput" value="<%= vinoInPagina.getCantina()%>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="localitaInputId"
						name="localitaInput" value="<%= vinoInPagina.getLocalita()%>">
					<input class="form-control" type="hidden" id="idInputId"
						name="idInput" value="<%= vinoInPagina.getId()%>">
				</div>
			</div>
