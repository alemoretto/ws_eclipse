	  ...
	  <h3>Pagina di Ricerca Abitante</h3>
      	...
      	<form class="form-horizontal" action="ExecuteSearchAbitanteServlet" method="post">
      		<div class="form-group">
      			<label class="control-label col-sm-2" for="descrizioneInputId">Nome:</label>
	    		<div class="col-sm-4">
			...
			<div class="form-group">
		      ...
		      <div class="col-sm-offset-2 col-sm-10">
		        ...
		        <a href="PrepareInsertAbitanteServlet" class="btn btn-primary btn-md">Inserisci Nuovo Abitante</a>
		      </div>
		    </div>
		</form>
